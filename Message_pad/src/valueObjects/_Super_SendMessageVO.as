...
public class _Super_SendMessageVO extends flash.events.EventDispatcher implements com.adobe.fiber.valueobjects.IValueObject
{
     ...
     * properties
     */
    private var _internal_bUrl : Boolean;
    ...
    private var _internal_urlKey : int;
    ...
    [Bindable(event="propertyChange")]
    public function get urlKey() : int
    {
        return _internal_urlKey;
    }
    ...
    public function set bUrl(value:Boolean) : void
    {
        var oldValue:Boolean = _internal_bUrl;
        if (oldValue !== value)
        {
            _internal_bUrl = value;
            this.dispatchEvent(mx.events.PropertyChangeEvent.createUpdateEvent(this, "bUrl", oldValue, _internal_bUrl));
        }
    }
    ...
    public function set urlKey(value:int) : void
    {
        var oldValue:int = _internal_urlKey;
        if (oldValue !== value)
        {
            _internal_urlKey = value;
            this.dispatchEvent(mx.events.PropertyChangeEvent.createUpdateEvent(this, "urlKey", oldValue, _internal_urlKey));
        }
    }
