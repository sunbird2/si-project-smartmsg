...
internal class _ResultSetEntityMetadata extends com.adobe.fiber.valueobjects.AbstractEntityMetadata
{
    ...
    model_internal static var nonDerivedProperties:Array = new Array("fetchSize", "holdability", "last", "beforeFirst", "type", "cursorName", "row", "statement", "fetchDirection", "afterLast", "concurrency", "closed", "warnings", "first", "metaData");
