 ...
 * of this value object you may modify the generated sub-class of this class - PointVO.as.
 */
...
[ExcludeClass]
public class _Super_PointVO extends flash.events.EventDispatcher implements com.adobe.fiber.valueobjects.IValueObject
{
    model_internal static function initRemoteClassAliasSingle(cz:Class) : void
    {
        try
        {
            if (flash.net.getClassByAlias("com.m.point.PointVO") == null)
            {
                flash.net.registerClassAlias("com.m.point.PointVO", cz);
            }
        }
        catch (e:Error)
        {
    ...
    model_internal var _dminternal_model : _PointVOEntityMetadata;
    ...
    public function _Super_PointVO()
    {
        _model = new _PointVOEntityMetadata(this);
    ...
    [Transient]
    [Bindable(event="propertyChange")]
    public function get _model() : _PointVOEntityMetadata
    {
        return model_internal::_dminternal_model;
    }

    public function set _model(value : _PointVOEntityMetadata) : void
    {
        var oldValue : _PointVOEntityMetadata = model_internal::_dminternal_model;
        if (oldValue !== value)
        {
