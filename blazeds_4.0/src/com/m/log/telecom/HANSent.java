...
public class HANSent implements ISentData {
	
	static ISentData sent = new HANSent();
	...
	public ArrayList<MessageVO> getListDetail(Connection conn, LogVO slvo) {
		...
		if (slvo.getMode().equals("LMS") || slvo.getMode().equals("MMS")) {
			...
			SQL = VbyP.getSQL( "sent_lg_select_mms_search" ).replaceAll("MMS_", "MMSHAN_");
		}
		else {
			if ( !SLibrary.isNull( slvo.getSearch() )) where = whereSMS(slvo.getSearch());
			SQL = VbyP.getSQL( "sent_lg_select_search" ).replaceAll("SC_", "HAN_");
		}
	...
	public ArrayList<MessageVO> getListDetail(Connection conn, LogVO slvo, int startIndex, int numItems) {
		...
		if (slvo.getMode().equals("LMS") || slvo.getMode().equals("MMS")){
			...
			SQL = SLibrary.messageFormat( VbyP.getSQL( "sent_lg_select_mms_paged" ).replaceAll("MMS_", "MMSHAN_") , new Object[]{where} );
		}
		else {
			if ( !SLibrary.isNull( slvo.getSearch() )) {
				where = whereSMS(slvo.getSearch());
			}
			SQL = SLibrary.messageFormat( VbyP.getSQL( "sent_lg_select_paged" ).replaceAll("SC_", "HAN_") , new Object[]{where} );
		}
	...
	public Integer getListDetail_pagedCnt(Connection conn, LogVO slvo) {
		...
		if (slvo.getMode().equals("LMS") || slvo.getMode().equals("MMS")){
			...
			SQL = SLibrary.messageFormat( VbyP.getSQL( "sent_lg_select_mms_paged_count" ).replaceAll("MMS_", "MMSHAN_") , new Object[]{where} );
		}
		else {
			if ( !SLibrary.isNull( slvo.getSearch() )) {
				where = whereSMS(slvo.getSearch());
			}
			SQL = SLibrary.messageFormat( VbyP.getSQL( "sent_lg_select_paged_count" ).replaceAll("SC_", "HAN_") , new Object[]{where} );
		}
	...
	public SentStatusVO getListDetail_status(Connection conn, LogVO slvo) {
		...
		String SQL = "";
		if (slvo.getMode().equals("LMS") || slvo.getMode().equals("MMS")) SQL = VbyP.getSQL( "sent_lg_select_mms_status" ).replaceAll("MMS_", "MMSHAN_");
		else SQL = VbyP.getSQL( "sent_lg_select_status" ).replaceAll("SC_", "HAN_");
	...
	public int getCancelAbleCount(Connection conn, LogVO slvo) {
		...
		String SQL = "";
		if (slvo.getMode().equals("LMS") || slvo.getMode().equals("MMS")) SQL = VbyP.getSQL( "sent_lg_cancel_count_mms" ).replaceAll("MMS_", "MMSHAN_");
		else SQL = VbyP.getSQL( "sent_lg_cancel_count" ).replaceAll("SC_", "HAN_");
	...
	public int getCount(Connection conn, LogVO slvo) {
		...
		String SQL = "";
		if (slvo.getMode().equals("LMS") || slvo.getMode().equals("MMS")) SQL = VbyP.getSQL( "sent_lg_count_mms" ).replaceAll("MMS_", "MMSHAN_");
		else SQL = VbyP.getSQL( "sent_lg_count" ).replaceAll("SC_", "HAN_");
	...
	public int cancel(Connection conn, LogVO slvo) {
		...
		String SQL = "";
		if (slvo.getMode().equals("LMS") || slvo.getMode().equals("MMS")) SQL = VbyP.getSQL( "sent_lg_cancel_mms" ).replaceAll("MMS_", "MMSHAN_");
		else SQL = VbyP.getSQL( "sent_lg_cancel" ).replaceAll("SC_", "HAN_");
	...
	public int failUpdate(Connection conn, LogVO lvo) {
		...
		String SQL = "";
		if (lvo.getMode().equals("LMS") || lvo.getMode().equals("MMS")) SQL = VbyP.getSQL( "sent_lg_fail_update_mms" ).replaceAll("MMS_", "MMSHAN_");
		else SQL = VbyP.getSQL( "sent_lg_fail_update" ).replaceAll("SC_", "HAN_");
