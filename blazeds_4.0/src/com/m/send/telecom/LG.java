...
public class LG implements ILineSet {

	static ILineSet send = new LG();
	...
	public String getInsertQuery(String mode) {
		...
		String query = "";
		if (mode.equals("SMS")) query = VbyP.getSQL("insertLGClient");
		else if (mode.equals("LMS")) query = VbyP.getSQL("insertLGLMSClient");
		else if (mode.equals("MMS")) query = VbyP.getSQL("insertLGMMSClient");
		return query; 
	}
