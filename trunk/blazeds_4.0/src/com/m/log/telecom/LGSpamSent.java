...
public class LGSpamSent implements ISentData {
	
	static ISentData sent = new LGSpamSent();
	...
	public ArrayList<MessageVO> getListDetail(Connection conn, LogVO slvo) {
		...
		if (slvo.getMode().equals("LMS") || slvo.getMode().equals("MMS")) {
			...
			SQL = VbyP.getSQL( "sent_lg_select_search" ).replaceAll("SC_", "SCSPAM_");
		}
	...
	public ArrayList<MessageVO> getListDetail(Connection conn, LogVO slvo, int startIndex, int numItems) {
		...
		if (slvo.getMode().equals("LMS") || slvo.getMode().equals("MMS")){
			...
			SQL = SLibrary.messageFormat( VbyP.getSQL( "sent_lg_select_paged" ).replaceAll("SC_", "SCSPAM_") , new Object[]{where} );
		}
	...
	public Integer getListDetail_pagedCnt(Connection conn, LogVO slvo) {
		...
		if (slvo.getMode().equals("LMS") || slvo.getMode().equals("MMS")){
			...
			SQL = SLibrary.messageFormat( VbyP.getSQL( "sent_lg_select_paged_count" ).replaceAll("SC_", "SCSPAM_") , new Object[]{where} );
		}
