package lib
{
	 ...
	 */
	public class AppProgressBar extends Sprite implements IPreloaderDisplay
	{
		...
		private var bgColors:Array = [ 0xFFFFFF ];
		...
		private function createAssets():void {
			...
			if (boxColors.length == 2) {
				...
				mainBox.graphics.beginGradientFill(GradientType.LINEAR, boxColors, [1, 0.9], [0, 255], matrix);
			} else {
