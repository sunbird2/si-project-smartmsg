...
internal class _ConnectionEntityMetadata extends com.adobe.fiber.valueobjects.AbstractEntityMetadata
{
    ...
    model_internal static var nonDerivedProperties:Array = new Array("autoCommit", "readOnly", "holdability", "typeMap", "catalog", "closed", "transactionIsolation", "clientInfo", "warnings", "metaData");
