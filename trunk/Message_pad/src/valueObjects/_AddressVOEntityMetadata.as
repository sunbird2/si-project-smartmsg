...
internal class _AddressVOEntityMetadata extends com.adobe.fiber.valueobjects.AbstractEntityMetadata
{
    ...
    model_internal static var allProperties:Array = new Array("grpName", "writedate", "grp", "phone", "idx", "memo", "name", "user_id", "etcInfo");
    model_internal static var allAssociationProperties:Array = new Array();
    model_internal static var allRequiredProperties:Array = new Array();
    model_internal static var allAlwaysAvailableProperties:Array = new Array("grpName", "writedate", "grp", "phone", "idx", "memo", "name", "user_id", "etcInfo");
    model_internal static var guardedProperties:Array = new Array();
    model_internal static var dataProperties:Array = new Array("grpName", "writedate", "grp", "phone", "idx", "memo", "name", "user_id", "etcInfo");
    model_internal static var sourceProperties:Array = emptyArray
    model_internal static var nonDerivedProperties:Array = new Array("grpName", "writedate", "grp", "phone", "idx", "memo", "name", "user_id", "etcInfo");
